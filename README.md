...
Say To Any 是一个 Windows/macOS 桌面听写工具：录音、调用 OpenAI 兼容语音识别接口、可选调用大模型整理文本，然后把结果复制或自动粘贴到当前输入位置。

## 功能特性

- Windows 双击 `Alt`、macOS 双击 `Option` 开始或停止听写，适合在任意输入框中快速调用。
...
- 使用 Velopack 支持 GitHub Release 更新与桌面端打包。

## 截图

![历史记录](asset/ScreenShot_2026-06-27_090927_472.png)

| 设置麦克风 | 识别结果 | 录音中 | 处理中 |
| --- | --- | --- | --- |
| ![设置麦克风](asset/ScreenShot_2026-06-27_091343_060.png) | ![识别结果浮窗](asset/ScreenShot_2026-06-27_091405_000.png) | ![录音浮窗](asset/ScreenShot_2026-06-27_091433_942.png) | ![处理中浮窗](asset/ScreenShot_2026-06-27_091442_662.png) |

## 快速开始

### 下载使用

前往 [Releases](https://github.com/largeprob/say-to-any/releases) 下载最新 Windows 或 macOS 版本。
